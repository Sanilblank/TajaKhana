...
@section('content')
    <div class="right_col" role="main">
        ...
        @endif
        <h1 class="mt-3">Create Menu Item <a href="{{ route('menuitem.index') }}" class="btn btn-primary btn-sm"> <i
                    class="fa fa-eye" aria-hidden="true"></i> View Items</a></h1>
        <div class="card mt-3">

            <form action="{{ route('menuitem.store') }}" method="POST" class="bg-light p-3" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-md-6">
